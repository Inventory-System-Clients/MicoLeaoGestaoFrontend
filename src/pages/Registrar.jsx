      ...
      <div className="relative card-gradient max-w-md w-full backdrop-blur-sm">
        ...
        <div className="text-center mb-6">
          ...
          <img
            ...
            alt="Mico Leao"
            className="mx-auto mb-3 h-28 w-28 rounded-2xl bg-white object-contain p-2 shadow-2xl ring-1 ring-primary/10"
          />
          <h1 className="text-3xl font-bold mb-1">
            <span className="text-gradient">Criar Conta</span>
          </h1>
          <p className="text-gray-600 text-sm">
            Junte-se ao Sistema Mico Leao
          </p>
        </div>
